...
namespace Yurui.Tools.Security
{
    /// <summary>
    /// 常用的加密解密算法
    /// </summary>
    public static class Encrypt
    {
        ...
        #region DES对称加密解密
        /// <summary>
        /// 加密密钥，需要在config配置文件中AppSettings节点中配置desSecret值，若未配置，默认取“yurui”的MD5值
        /// </summary>
        public static string DEFAULT_ENCRYPT_KEY = ConfigurationManager.AppSettings["desSecret"] ?? "yurui".MDString2();
        /// <summary>
        /// 使用默认加密
        /// </summary>
