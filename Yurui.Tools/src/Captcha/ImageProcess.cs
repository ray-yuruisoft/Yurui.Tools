...
namespace Yurui.Tools.Captcha
{
    public static class ImageProcess
    {
        ...
        */
        ...
        public static Bitmap Gray(Bitmap img, GrayscaleType type = GrayscaleType.Mean)
        {
        ...
        /// <returns></returns>
        public static void SmoothHistGram(int[] pixelNum)
        {
        ...
        public static Bitmap PBinary(Bitmap src, int v)
        {
            int w = src.Width;
            int h = src.Height;
            Bitmap dstBitmap = new Bitmap(src.Width, src.Height, PixelFormat.Format32bppRgb);
