...
namespace Yurui.Tools.Test
{
    ...
    public class CaptchaUnitTest
    {
        ...
        //    watch.Reset();
        //    watch.Start();
        //    Binaryzation h = new Binaryzation(new Bitmap(captcha01Path));
        //    h.DestBmp.Save($@"{System.Environment.CurrentDirectory}\imgs\Codeimghandler.jpg");
        //    watch.Stop();
        //    System.Diagnostics.Debug.WriteLine("t2消耗：{0}(毫秒)", watch.Elapsed.TotalMilliseconds);

        //    h.SrcBmp = new Bitmap($@"{System.Environment.CurrentDirectory}\imgs\Codeimg.jpg");
        //    h.Generate();

        //    h.DestBmp.Save($@"{System.Environment.CurrentDirectory}\imgs\Codeimghandler2.jpg");
        ...
        //    //captchaHandler.isGray = true;
        //    //captchaHandler.isSmooth = true;
        //    //captchaHandler.Reload();

        //    //captchaHandler.DestBmp.Save($@"{System.Environment.CurrentDirectory}\imgs\Codeimg (2)destReload.jpg");
